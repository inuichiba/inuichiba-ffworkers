...
const msgB11y = "あのお祭り感のある夜市が戻ってきます！\nそして犬市場 夜市　2日間開催決定！\n\n開催概要\n" +
  "◆開催日 /8月16日(土)　17日(日) 小雨決行・荒天中止\n発表はSNSでします。\n◆開催時間 / 16日(土) 16:30〜21:30 / 17日(日) 16:30〜21:00\n" +
  "◆開催場所 /愛知県岡崎城公園第6号乙川河川緑地\n◆住所 /〒444-0052 愛知県岡崎市康生町５２１\n◆入場料 / 1日500円(小学生以下無料)\n" +
  "◆出店店舗 / 約100ブース(予定)\n◆主催 / WAN'S team\n◆来場予定人数 / 8,000人(予定)\nその他イベントの詳細は、決まり次第インスタグラムで告知していくよ！";
const msgB12y = "犬市場夜市のフライヤーです。\nインスタグラムでお友達に「いくよぉ〜！」とお知らせ用に使ってくださいね！";
const msgB13y = "【A-GELギフトポイントの導入】\nこの度、「犬市場 夜市」よりA-GELギフトポイントが導入となります。\nオトクに買い物が楽しめちゃう♫\n" +
  "ぜひ、ダウンロードしてご使用ください！\nまた、夜市ではご来場者さまに限りA-GELギフトポイント １０００円分を プレゼントいたします！\nさらに\n" +
  "P&R（パークアンドライド）をご利用の方には、 ５００円分を 追加プレゼントいたします！\n\n夜市では、”A-GELギフトポイント使用体験ブース”にておやつの試食もできちゃう♫\n" +
  "A-GELギフトポイント体験してみてくださいね！\n\nMAPにもA-GELギフトポイント加盟店のマーク「A」がついてるよ！\n探してみてくださいね！\n※加盟店のギフトカードは準備が整い次第アプリ内で公開いたします\n\n" +
  "ダウンロードはこちら\nApp Store→https://apps.apple.com/jp/app/a-gel%E3%83%A6%E3%83%BC%E3%82%B6/id6465175244\nGoogle Play→https://play.google.com/store/apps/details?id=jp.co.pointKikou.AgelUser&hl=ja&pli=1\n" +
  "※A-GELギフトポイントは、「犬市場」だけではなく、全国で使えるアプリとなっております。\n気になるお店を見つけてオトクにお買い物・サービスをお楽しみください。";

const msgB31y = "🚗🐾パークアンドライドのご案内🐾🚗\n🐕‍🦺愛犬との特別な1日を、移動から楽しもう！✨\nパークアンドライドを使えば、スムーズで気持ちのいいスタートがきれます！\n" +
  "会場までの道のりを、ストレスフリーに楽しむなら、パークアンドライドがオススメ！💡\n車を停めたら、あとは大型バスで快適移動🚌✨\n愛犬と一緒に、ちょっとした旅気分を味わいながら会場へGO！🌟🐶\n\n" +
  "🌟3つのポイントで選ばれています！🌟\n① 混雑知らずでスイスイ到着！🚦🛣️\n会場近くの渋滞や駐車場探しのイライラを解消！🎉\n\n" +
  "② シャトルバスで愛犬と一緒にリラックス♪🚌💺\nペット対応OKだから安心。🐕✨ ワクワクする時間をプラス！🎈\n\n" +
  "③ 駐車も安心＆低コスト！🅿️💸\n指定駐車場は広々スペースで、駐車料金は無料！🆓\n※駐車場の数には限りがあるので、早めのご利用がおすすめです！⏰🚗";
const msgB32y = "パークアンドライド詳細\n\n駐車場場所\n◆岡崎中央総合公園駐車場 美博2・美博3😁⚽️\n　〒444-0002　愛知県岡崎市高隆寺町峠1番地（付近）\n" +
  "　※詳しくは画像もしくは下記をご確認ください\n・駐車可能時間：22:00まで\n（22:00を過ぎますと翌朝6:00まで出すことができません）\n\n" +
  "◆犬市場　桜城橋停留所🌸\n〒444-0043　 愛知県岡崎市唐沢町１丁目\nバス停留所から犬市場会場まで河川敷の遊歩道を利用し安全にご移動いただけます\n" +
  "・最終出発時間：16日(土) 21：30　/　17日(日)21：20\n（最終便は大変混雑が予想されます。計画的なご利用をお願いいたします）\n\n" +
  "ーーーーーーーーーーーーーーーー\n◆運行区間（運行時間：15〜20分）\n岡崎中央公園駐車場　美博2・美博3\n↕\n犬市場　桜城橋停留所\n\n" +
  "◆ご利用に関して\n犬市場　入場料500円をお支払いいただきご利用いただけます\n※小学生は無料\n※駐車料金/バス乗車料金 無料\n\n\n" +
  "詳細は下記URLよりご確認ください。\n🎈🎈https://inuichiba.com/cn7/pg1361614.html";
...
const msgB6y = "✨お待たせいたしました！\n下記よりご確認いただけます👇📄\n\nまた、URLよりMAPのダウンロードも可能です🗺️📥\n" +
  "ぜひ、そちらも合わせてご確認ください！😊\nhttps://inuichiba.com/cn7/pg1359767.html";

const msgB71y = msgA70;
const msgB72y = "【新設有料駐車場】もございます。\n◆乙川河川緑地駐車場\n〒444-0053 愛知県岡崎市板屋町221番地（付近）\n開場:15:30〜22:00まで\n1台500円でご利用可能ですのでこちらもご利用ください。\n約400台収容可※下記地図参照・一方通行あり\n特設駐車場につきカーナビにはでてきませんので地図をご参照ください\n\n◆明神橋公園臨時駐車場\n〒444-0858 愛知県岡崎市上六名１丁目１−９（付近）\n開場:15:30〜22:00まで\n1台500円でご利用可能ですのでこちらもご利用ください。\n約300台収容可※下記地図参照・一方通行あり\n特設駐車場につきカーナビにはでてきませんので地図をご参照ください";
const msgB73y = "臨時駐車場は22:00を過ぎますと施錠を致します\n施錠をしますと明朝までお車は出すことはできなくなりますので、必ず時間内にお車の退出をお願い致します。\n\n※コムタウンなどの近隣商業施設駐車場の無断駐車は絶対にしないでください。\n※西三河総合庁舎の駐車場はイベント利用者様は利用出来ません。";
...
const msgCongested = "⚠️ 現在アクセスが集中しているため、一時的にサービスのご利用を制限しております。\n申し訳ありませんが、午前9時以降に改めてお試しください。";
...
// //////////////////////////////////////////////////
// 呼び出し側で文字列置換する
const flagInputTemplate = `【重要なお知らせ】\n\n` +
  `現在の仕組みでは、ffprod と ffdev の両方に自動でコマンドを送信することができません。\n` +
  `そのため、この操作は手作業で行っていただく必要があります。\n\n` +
  `【お願いしたいこと】\n下の手順で、LINEの「__ffdev__」トーク画面にて、指定のキーワードを入力して送信してください。\n\n` +
  `────────────────────────\n\n1. 「__ffdev__」とのLINEトークを開いてください。\n\n` +
  `2. トーク画面の下にある入力欄に、次のキーワードを入力してください。\n\n` +
  ` __flag__\n\n3. 入力が終わったら、そのまま送信してください。\n\n` +
  `4.Discordで通知される件数を、ffprod(本番環境)とffdev(開発環境)とで合算してください。` +
  `\n課金枠はffprodとffdevの合算で計算されます(Supabaseは1ヶ月単位。KVはUTC計算で一日単位のため日本時間で朝9時頃にリセットされます)。` +
  `\n\n5.その合算値に応じて、適切な処置をとってください。\n\n────────────────────────\n\n` +
  `【この操作が必要な理由】\nffprod と ffdev は異なる環境として動作しており、システムから両方へ同時にコマンドを送信する機能がありません。\n` +
  `そのため、もう一方の環境には手動でコマンドを送っていただく必要があります。\n\n` +
  `※分からない場合やうまくいかない場合は、担当者までご連絡ください。`;
...
const mediaMessages = {
  "tap_richMenuB1y": [
    { type: "text", text: msgB11y },
    { type: "text", text: msgB12y },
    {
      type: "image",
      originalContentUrl: `${baseDir}images/y_flyer.jpg`,
      previewImageUrl:    `${baseDir}images/y_flyer.jpg`
    },
    { type: "text", text: msgB13y },
    {
      type: "image",
      originalContentUrl: `${baseDir}images/y_a-gel-gift.jpg`,
      previewImageUrl:    `${baseDir}images/y_a-gel-gift.jpg`
    }
  ],
  "tap_richMenuB4y": [
    { type: "text", text: msgB41y },
    { type: "text", text: msgB42y },
    {
      type: "image",
  ...
  "tap_richMenuB7y": [
    { type: "text", text: msgB71y },
    { type: "text", text: msgB72y },
    { type: "text", text: msgB73y },
    {
      type: "image",
      originalContentUrl: `${baseDir}carousel_yoichi/y_parking.jpg`,
      previewImageUrl:    `${baseDir}carousel_yoichi/y_parking.jpg`
    }
  ]
};
